...
// import { List, Colors, TouchableRipple } from "react-native-paper";
...
//   TouchableHighlight
// } from "react-native";
// //   const backColor = this.props.selected ? '#fff' : '#e0ebeb';

// const customData = data.filter(x => x.verified === 1);
...
//       //NEEDS FIXING
//       <TouchableRipple
//         underlayColor="#e0ebeb"
//         onPress={() => console.log(Information.stallName)}
//         rippleColor="#e0ebeb"
//       >
